        ...
        try{
            ...
            if( Cid == 1) {
                stmt.execute("INSERT INTO Cart VALUES "
                        + "( "+counter+", 1 , 'ShoeExtreme', 'The Extreme shoe for Extreme People', 3.43)");
            }
            else if ( Cid == 2) {
                stmt.execute("INSERT INTO Cart VALUES "
                        + "("+counter+", 2 , 'Thing Shirt', 'The shirt with a thing on it.', 335.34)");
            }
            else if ( Cid == 3) {
                stmt.execute("INSERT INTO Cart VALUES "
                        + "("+counter+", 3 , 'Super Tee', 'The last Tee You will ever need', 1.11)");
            }
            else if ( Cid == 4) {
                stmt.execute("INSERT INTO Cart VALUES "
                        + "("+counter+", 4 , 'Best Wife Beater', 'Be the worst beater u can be in this best wife beater', 99.99)");
            }
            counter++;
            stmt.close();
            conn.close();
